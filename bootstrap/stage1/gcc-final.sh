...
mkdir -pv $RLXOS_TGT/libgcc
ln -s ../../../libgcc/gthr-posix.h $RLXOS_TGT/libgcc/gthr-default.h
...
../configure \
    ...
    --prefix=/usr \
    --libexecdir=/usr/lib \
    CC_FOR_TARGET=$RLXOS_TGT-gcc \
    --with-build-sysroot=$RLX \
